...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-30 w-full shadow-xl shadow-blue-600/20 sm:px-4">
      <nav className="py-3 bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
